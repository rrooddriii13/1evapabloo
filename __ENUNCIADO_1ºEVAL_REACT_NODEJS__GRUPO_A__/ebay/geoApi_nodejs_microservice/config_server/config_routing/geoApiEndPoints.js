...
function verificaToken(req,res,next){
    try {
        ...
        let _payload=jsonwebtoken.verify(_jwt, process.env.JWT_SECRETKEY,{ issuer: 'http://localhost:6666'});
        if (_payload === '') throw new Error('error al verificar accessToken, o ha expirado o firma invalida no pertenece al localhost:6666');
