...
let restCliente={
    ...
    ActualizarDirecciones: async function(idCliente, direcciones){
        let _pet=await fetch('http://localhost:3003/api/zonaCliente/ActualizarDirecciones',
            {
               method: 'POST',
               headers:{ 'Content-Type': 'application/json'},
       ...
       console.log('respuesta de actualizacion de direcciones cliente...', _resp);
