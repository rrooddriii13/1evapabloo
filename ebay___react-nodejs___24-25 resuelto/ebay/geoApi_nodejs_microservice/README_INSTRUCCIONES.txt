...
tienen una caducidad de 15 minutos, despues caducaran y tendras q volver a solicitarlo para poder acceder a los endpoints del servicio REST
    ...
    - para recuprerar municipios, el endpoint es: http://localhost:6666/api/GeoApi/ListaMunicipios?codProv=28  por GET( se pasa en parametro codProv el codigo provincia a recuperar)
